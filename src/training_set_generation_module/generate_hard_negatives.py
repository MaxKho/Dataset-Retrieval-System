...
with open("../data/data/2_intermediate_data/pairs_new.json") as f:
    pairs = json.load(f)
...
with open("../data/data/2_intermediate_data/pairs_with_negatives.json", "w") as f:
    json.dump(pairs, f, indent=2)

print("✅ Pairs with negatives complete.")
