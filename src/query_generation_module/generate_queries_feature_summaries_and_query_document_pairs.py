...
# Load dataset
with open("../data/data/1_raw_data/extracted_openml_data.json") as f:
    data = json.load(f)
...
with open("../data/data/2_intermediate_data/queries.jsonl", "w") as outfile:
...
with open("../data/data/2_intermediate_data/feature_summaries.jsonl", "w") as outfile:
...
with open("../data/data/2_intermediate_data/feature_summaries.jsonl") as f:
...
with open("../data/data/2_intermediate_data/documents.json", "w") as f:
    json.dump(data, f, indent=2)

print("✅ documents.json file with summarised features created.")

# Create new file combining queries and documents
with open("../data/data/2_intermediate_data/queries.jsonl") as f:
    queries = [json.loads(line) for line in f]

with open("../data/data/2_intermediate_data/documents.json") as f:
    documents = json.load(f)

for original, gen in zip(documents, queries):
    original["query"] = gen.get("query", None)

with open("../data/data/2_intermediate_data/pairs.json", "w") as f:
    json.dump(documents, f, indent=2)

print("✅ pairs.json file with queries successfully created.")

with open("../data/data/2_intermediate_data/pairs.json") as f:
    pairs = json.load(f)
