...
with open('../data/final_train.json', 'w', encoding='utf-8') as f:
    json.dump(train_data, f, indent=4)

with open('../data/final_valid.json', 'w', encoding='utf-8') as f:
    json.dump(valid_data, f, indent=4)

with open('../data/final_test.json', 'w', encoding='utf-8') as f:
